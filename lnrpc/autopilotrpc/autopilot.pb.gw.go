...
var (
	filter_Autopilot_QueryScores_0 = &utilities.DoubleArray{Encoding: map[string]int{"User_Id": 0}, Base: []int{1, 1, 0}, Check: []int{0, 1, 2}}
)
...
var (
	pattern_Autopilot_Status_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"v2", "autopilot", "status", "User_Id"}, ""))

	pattern_Autopilot_ModifyStatus_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"v2", "autopilot", "modify", "User_Id"}, ""))

	pattern_Autopilot_QueryScores_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"v2", "autopilot", "scores", "User_Id"}, ""))

	pattern_Autopilot_SetScores_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"v2", "autopilot", "scores", "User_Id"}, ""))
)
